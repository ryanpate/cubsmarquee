...
class GameConfig:
    ...
    CLOCK_DISPLAY_DURATION: int = 1
    CUBS_HISTORY_DURATION: int = 2
    SKY_DISPLAY_DURATION: int = 2
    ISS_DISPLAY_DURATION: int = 1
    CELEBRATION_DURATION: int = 2
    ...
    ROUTE_CACHE_DB_PATH: str = '/var/tmp/flight_routes.db'
